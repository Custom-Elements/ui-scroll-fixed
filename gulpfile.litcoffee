Build ui-scroll-fixed from source into
build/ui-scroll-fixed.html, all streamlined and ready to be included.
...
Vulcanize for the speed.
    ...
    gulp.task 'vulcanize', ['elements'], ->
      built = 'build/ui-scroll-fixed.html'
      gulp.src ''
        .pipe shell([
          "vulcanize --inline --strip -o ui-scroll-fixed.html #{__dirname}/build/*.html"
          ])
